<template>
    <div class="container">
        ...
        <div class="main layoutWrap clearfix">
           <template>
                <Breadcrumb firstName="首页" secondName="Ta的主页" thirdName="我的视频" firstLink="/" :secondLink="secondLink"></Breadcrumb>
            </template>
            <div class="videoMain">
                <div class="video-nav">
                    Ta的视频
    ...
    export default {
        ...
        methods:{
         ...
         created() {
            ...
            this.secondLink = '/memberPersonCenter?userId='+this.userId;
        },
        mounted() {
            this.getVodeoListLim(1);
        },
