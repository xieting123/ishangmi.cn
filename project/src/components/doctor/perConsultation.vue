<template>
    <div class="container">
        ...
        <div class="main layoutWrap clearfix shangdao">
            <template>
                <Breadcrumb firstName="首页" secondName="TA的解答" firstLink="/" ></Breadcrumb>
            </template> 
                       ...
                       <div class="clearfix">
                        ...
                        <div class="replyCotentWrap clearfix blockHover" v-if="JSON.stringify(item.consultationAnswer) != '{}'">
                            ...
                            <div class="head-info lt" style="width:100%;">
                                ...
                                <router-link class="linkTo" :to="{ name: 'MemberPersonCenter', query: {userId:item.consultationAnswer.userId}}">
            ...
            adviceDoctorList(pageNum) {
                ...
                adviceDoctorList(data).then(res => {
                    if (res.code === 200) {
                        ...
                        this.$router.push({
                            path: '/Login',
                            query: {redirect: '/doctor/perConsultation?userId='+this.userId}
                        });
                    }
                     else {
                        this.$message({
