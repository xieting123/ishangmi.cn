<template>
    <div class="container">
        ...
        <div class="main layoutWrap clearfix minH60">
           <template>
                <BreadcrumbMult firstName="首页" secondName="名医咨询" firstLink="/" secondLink="/doctorList" thirdName="名医咨询详情"></BreadcrumbMult>
            </template>
        </div>
                    ...
                    <li class="business-road ">
                       <div class="clearfix">
                            <div class="head-info lt">
                                <router-link class="linkTo" :to="{ name: 'MemberPersonCenter', query: {userId:baseData.userId}}">
                ...
                <div class="toAnswerWrap">
                    <div class="commentFormWrap clearfix">
                        <el-form ref="commentForm" :model="commentForm" class="clearfix rt" style="width:600px; margin-top:15px;">
                            ...
                            <el-form-item>
                                <a href="javascript:;" class="btnDanger_small rt" @click="adviceDoctorReply">我来解答</a>
...
<script>
    import {getAdviceDetail,adviceCommonList,adviceDoctorReply,adviceAnswerLike,alipay, wxpay, myselfPayway} from '@/api/api'
        ...
        methods: {
            ...
            adviceAnswerLike(item){
                ...
                adviceAnswerLike(data).then(res => {
                    if (res.code === 200) {
                        ...
                        this.$router.push({
                            path: '/Login',
                            query: {redirect: '/doctorConsultationDetail?consultationId='+this.consultationId} // 如果你使用钩子函数，your path 可以替换成to.fullPath
                        });
                    } 
                    else {
                        this.$message({
            ...
            adviceDoctorReply() {
                if(this.commentForm.answerContent){
                    ...
                    adviceDoctorReply(data).then(res => {
                        if (res.code === 200) {
