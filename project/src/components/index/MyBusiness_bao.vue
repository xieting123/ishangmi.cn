<template>
    <div class="container">
        ...
        <div class="main layoutWrap clearfix">
           <template>
                <Breadcrumb firstName="首页" secondName="我的商报" firstLink="/" ></Breadcrumb>
            </template>
            <div class="videoMain"> 
                <div class="video-nav">
                    <div class="buildItem">
                        我发布的商报<span class="video-num"> {{totalCount}}个</span>
                    </div>
                    <router-link :to="{ name: 'Publish_bao', params: {}}" class="btnDanger uploadVideo">发布商报</router-link>
                </div>               
            </div>  
        </div>
            ...
            <div class="centerCon clearfix">
                <div class="findbusiness_wrap">
                    <template v-if="isNodata_msg" >
                        <NoData textMsg="您还没有发布任何商报！！！"></NoData>
                    </template>
                    <ul class="clearfix minH320" v-loading="loading">
                        <li class="business-road blockHover" v-for="item in listData" v-bind:key="item.key">
                            ...
                            <div class="top">
                                ...
                                <div class="operation">
                                    <router-link :to="{ name: 'Editor_bao', query: {newsId:item.id}}">
                                        <img src="./../../assets/index/editorA.png" alt="">
                                    </router-link>
                                    <a href="javascript:;" @click.stop="newsAndavenuesDel(item.id)">
