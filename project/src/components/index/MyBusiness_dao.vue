<template>
    <div class="container">
        ...
        <div class="main layoutWrap clearfix">
           <template>
                <Breadcrumb firstName="首页" secondName="我的商道" firstLink="/" ></Breadcrumb>
            </template>
            <div class="videoMain"> 
                <div class="video-nav">
                    <div class="buildItem">
                        我发布的商道<span class="video-num"> {{totalCount}}个</span>
                    </div>
                    <router-link :to="{ name: 'Publish_dao', params: {}}" class="btnDanger uploadVideo">发布商道</router-link>
                </div>               
            </div>  
        </div>
                        ...
                        <li class="business-road blockHover" v-for="item in listData" v-bind:key="item.key">
                            ...
                            <div class="top">
                                ...
                                <div class="operation">
                                    ...
                                    <a href="javascript:;" @click.stop="avenuesDel(item.id)">
