<template>
    <div class="container">
        ...
        <div class="main layoutWrap clearfix minH60">
           <template>
                <BreadcrumbMult firstName="首页" secondName="商道列表" firstLink="/" secondLink="/business_dao" thirdName="商道详情"></BreadcrumbMult>
            </template>
        </div>
            ...
            <div class="page-limit clearfix">
                <div class="leftCon lt">
                    <h3 class="avenuesTitle clearfix">
                        ...
                        <div class="giveRewardCount rt">打赏：{{avenuesDetailData.rewardCount}}</div>
                    </h3>
                    ...
                    <div class="like clearfix">
                        ...
                        <a href="javascript:;" class="giveReward" @click="giveRewardDialog"><img :src="borderRdius" alt="">支持Ta</a>
                    </div>
...
<script>
    ...
    import {listAvenuesDetail,avenuesPraise,avenuesCommentSubmit,avenuesCommentList,accountsLike,accountsCancelLike,mobileShare, alipay, wxpay, myselfPayway} from '@/api/api';
    ...
    export default {
        ...
        methods: {
            ...
            avenuesCommentList(pageNum){
                ...
                avenuesCommentList(data).then(res => {
                    if (res.code === 200) {
                        ...
                        if(this.rewardForm.payType==1){//支付宝
                            alipay(data).then(res => {
                                if (res.code === 200) {
                                    ...
                                    this.$router.push({
                                        path: '/Login',
                                        query: {redirect: '/index/avenuesDetail?newsId='+this.newsId} 
                                    });
                                }else {
                                    this.$message({
                                        message: res.msg,
