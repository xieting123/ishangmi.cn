                ...
                <div class="answerListWrap clearfix">
                    ...
                    <div class="right rt">
                        ...
                        <div class="authorPerInfo">
                            <router-link class="linkTo" :to="{ name: 'MemberPersonCenter', query: {userId:consultationDetailData.userId}}">
                                <img :src="consultationDetailData.trUser.avatar" class="defaultHead_Portrait_pic"/>
                            </router-link>
                            <div class="name">
                                {{consultationDetailData.trUser.name}}
                                <img src="./../../assets/index/video.png" alt="" v-if="consultationDetailData.trUser.verifyStatus===4">
                            </div>
                            <div class="division">
                                {{consultationDetailData.identityType===0?'商务人士':'技能达人'}}
                            </div>
                            ...
                            <div class="positionCompany">
                                <span class="company">{{consultationDetailData.trUser.company}}</span>                                
                                <span class="position separator">{{consultationDetailData.trUser.position}}</span>                                
                            </div>
                            <div class="contact">
                                <a href="javascript:;" @click="accountsLike(consultationDetailData.userId)" v-if="consultationDetailData.trUser.likeType===0||consultationDetailData.trUser.likeType===-1">关注Ta</a>
                                <a href="javascript:;" @click="accountsCancelLike(consultationDetailData.userId)" v-if="consultationDetailData.trUser.likeType===2" style="color: #999;text-decoration: none;">已关注</a>
                                <a href="javascript:;" @click="accountsCancelLike(consultationDetailData.userId)" v-if="consultationDetailData.trUser.likeType===4" style="color: #999;text-decoration: none;">互相关注</a>
                            </div>
                        </div>
                    </div>
                </div>
