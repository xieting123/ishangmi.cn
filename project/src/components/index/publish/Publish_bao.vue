<template>
    <div class="container">
        ...
        <div class="main layoutWrap clearfix" style="min-height: 76px;">
           <template>
                <Breadcrumb firstName="首页" secondName="我的商报" firstLink="/" secondLink='/index/myshangbao' thirdName="发布商报"></Breadcrumb>
            </template>
        </div>
        <div class="page-contain">
             <div class="page-limit">
                 <div class="pageWrap">
                    <h2 class="title">发布商报</h2>
                    <el-form ref="form" :model="form" label-width="98px">
                        <el-form-item label="商报标题">
                            <el-input v-model="form.newsTitle" placeholder="简要描述您的提问，突出您的咨询核心"></el-input>
                        </el-form-item>
                        <el-form-item label="商报详情">
                        ...
                        <el-form-item>
                            <div class="btnGroups">
                                <a href="javascript:;" class="btnPlain lt" @click="goBack('/index/myshangbao')">取消</a>
...
<script>
    ...
    export default {
            ...
            onSubmit() {
                ...
                newsPost(data).then(res => {
                    if (res.code === 200) {
                        ...
                        setTimeout(function(){
                            vm.$router.push('/index/myshangbao');
                        },800);
                    } else {
                        this.$message({
                            message: res.msg,
        ...
        mounted () {
            console.log(richTextFileUpload())
            this.createEditor()
        }
    }
</script>
