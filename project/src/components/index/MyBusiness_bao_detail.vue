<template>
    <div class="container">
        ...
        <div class="main layoutWrap clearfix minH60">
           <template>
                <BreadcrumbMult firstName="首页" secondName="商报列表" firstLink="/" secondLink="/business_bao" thirdName="商报详情"></BreadcrumbMult>
            </template>
        </div>
                ...
                <div class="leftCon lt">
                    <div class="newsTop clearfix">
                        <div class="head-info lt">
                            ...
                            <!-- <img :src="avenuesDetailData.trUser.avatar" class="head-info-img defaultHead_Portrait_pic" v-if="avenuesDetailData.isAnonymous===1"/> -->
                            <div class="head-info-name singleEllipsis">
                                {{avenuesDetailData.trUser.nickname}}
                                <img src="./../../assets/businessRoad/videoIcon.png" v-if="avenuesDetailData.trUser.verifyStatus===4">
                            </div>
                            <p class="head-info-intro">
                                <span v-for="item in avenuesDetailData.trUser.userIdentitys" class="fSpan" v-bind:key="item.key">{{item.identityName}}</span>
                                <span>|</span>
                                <span>{{avenuesDetailData.trUser.identityType===0?'商务人士':'技能达人'}}</span>
                            </p>
                        </div>
                    ...
                    <div class="commentWrap">
                        ...
                        <div class="commentFormWrap">
                            <el-form ref="commentForm" :model="commentForm" class="clearfix">
                                ...
                                <el-form-item>
                                    <a href="javascript:;" class="btnDanger_small rt" @click="avenuesCommentSubmit">提交</a>
                                </el-form-item>
                            </el-form>
                        </div>
                ...
                <div class="rightCon rt">
                    ...
                    <div class="authorPerInfo">
                        ...
                        <div class="positionCompany">
                            ...
                            <span class="position separator" v-if="avenuesDetailData.trUser.position">{{avenuesDetailData.trUser.position}}</span>                                
                        </div>
                        <div class="contact">
...
<script>
    ...
    export default {
        ...
        metaInfo() {
            return {
                title: '商报-'+this.shareTempData.title,
                htmlAttrs: {
                    lang: 'zh'
                },
                meta: [
