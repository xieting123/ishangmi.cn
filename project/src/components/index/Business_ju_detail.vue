            ...
            <div class="page-limit clearfix">
                ...
                <div class="memberListWrap rt">
                                ...
                                <dl class="clearfix">
                                    <dt class="lt">
                                        <div class="defaultHead_Portraits">
                                            <router-link class="linkTo" :to="{ name: 'MemberPersonCenter', query: {userId:item.user.id}}">
                    ...
                    <div class="authorPerInfo">
                        <router-link class="linkTo" :to="{ name: 'MemberPersonCenter', query: {userId:activityBaseDetail.userId}}">
                            <img :src="activityBaseDetail.user.avatar" class="defaultHead_Portrait_pic"/>
                        </router-link>
                        <div class="name">
                            {{activityBaseDetail.user.name}}
                            <img src="./../../assets/index/video.png" alt="" v-if="activityBaseDetail.user.verifyStatus===4">
                        </div>
                        <div class="division">
                            {{activityBaseDetail.identityType===0?'商务人士':'技能达人'}}
                        </div>
                        ...
                        <div class="positionCompany">
                            <span class="company singleEllipsis">{{activityBaseDetail.user.company}}</span>                                
                            <span class="position separator">{{activityBaseDetail.user.position}}</span>                                
                        </div>
                        <div class="contact">
                            <a href="javascript:;" @click="accountsLike(activityBaseDetail.userId)" v-if="activityBaseDetail.user.likeType===0||activityBaseDetail.user.likeType===-1">关注Ta</a>
                            <a href="javascript:;" @click="accountsCancelLike(activityBaseDetail.userId)" v-if="activityBaseDetail.user.likeType===2" style="color: #999;text-decoration: none;">已关注</a>
                            <a href="javascript:;" @click="accountsCancelLike(activityBaseDetail.userId)" v-if="activityBaseDetail.user.likeType===4" style="color: #999;text-decoration: none;">互相关注</a>
                        </div>
                    </div>
                </div>
            </div>
