        ...
        <div class="main layoutWrap clearfix">
           <template>
            ...
            <div class="videoMain"> 
                <div class="video-nav">
                    <div class="buildItem">
                        我发布的商讯<span class="video-num"> {{totalCount}}个</span>
                    </div>
                    <router-link :to="{ name: 'Publish_article', params: {}}" class="btnDanger uploadVideo">发布商讯</router-link>
                </div>               
            </div>  
        </div>
            ...
            <div class="centerCon clearfix">
                <div class="findbusiness_wrap">
                    <template v-if="isNodata_msg" >
                        <NoData textMsg="您还没有发布任何商讯！！！"></NoData>
                    </template>
