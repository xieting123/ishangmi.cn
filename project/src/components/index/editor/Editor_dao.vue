<template>
    <div class="container">
        ...
        <div class="main layoutWrap clearfix" style="min-height: 76px;">
           <template>
                <Breadcrumb firstName="首页" secondName="我的商道" firstLink="/" secondLink='/index/myshangdao' thirdName="编辑商道"></Breadcrumb>
            </template>
        </div>
                 ...
                 <div class="pageWrap">
                    ...
                    <el-form ref="form" :model="form" label-width="98px">
                        <el-form-item label="商道标题">
                            <el-input v-model="form.newsTitle" placeholder="简要描述您的提问，突出您的咨询核心"></el-input>
                        </el-form-item>
                        ...
                        <el-form-item>
                            <div class="btnGroups">
                                <a href="javascript:;" class="btnPlain lt" @click="goBack('/index/myshangdao')">取消</a>
    ...
    export default {
        ...
        methods: {
            ...
            createEditor(){  // 创建编辑器
                ...
                let vm = this;
                setTimeout(function(){
                    vm.editor.txt.html(vm.form.newsContent);  // 初始化内容
                },500)
            },
            ...
            onSubmit() {
                ...
                let vm =this;
                avenuesUpdate(data).then(res => {
                    if (res.code === 200) {
                        this.$message.success('修改商道成功！');
                        setTimeout(function(){
                            vm.$router.push('/index/myshangdao');
                        },800);
                    } else {
                        this.$message({
                            message: res.msg,
