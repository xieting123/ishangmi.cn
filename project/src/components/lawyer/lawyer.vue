        ...
        <div class="main layoutWrap clearfix shanglian">
           <div  class="business-love_left lt">
                <ul class="screeningLove">
                    ...
                    <li class="loveRegion clearfix">
                        <div class="region-key lt">专业</div>
                 ...
                 <ul class="searchList clearfix" v-loading="loading">
                    <li class="lt" v-for="item in listData" v-bind:key="item.key">
                        <div class="serchItem">
                            ...
                            <div class="serch-orgin">{{item.position?item.position:'无'}}</div>
...
<script>
    import {lawyerList,accountsLike,accountsCancelLike,chooseUserLawyerSelection} from '@/api/api';
    export default {
        data() {
            return {
                total:0,
