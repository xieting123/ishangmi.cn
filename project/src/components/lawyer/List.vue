           ...
           <template>
            ...
            <div class="pageMain">
                <div class="page-nav">
                    ...
                    <div class="buildItem">
                        <a href="javascript:;" :class="{ 'on': tabsCont===2}" @click="tabsClick(2,'说法')">说法</a>
                    </div>
                    <div class="buildItem">
                        <a href="javascript:;" :class="{ 'on': tabsCont===3}" @click="tabsClick(3,'律师')">律师</a>
                    </div>
                    <div class="btnGroups clearfix">
                        <router-link :to="{ name: 'Publish_consultation', params: {}}" class="btnDanger rt">法律咨询</router-link>
                        <router-link :to="{ name: 'Publish_bleachery', params: {}}" class="btnDanger rt">发布说法</router-link>
                    </div>
                </div>               
            </div> 
        </div>
