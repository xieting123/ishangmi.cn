<template>
    <div class="container">
        ...
        <div class="main layoutWrap clearfix" style="min-height: 76px;">
           <template>
                <BreadcrumbMult firstName="首页" secondName="律师" firstLink="/" secondLink='/lawyerList' thirdName="咨询"></BreadcrumbMult>
            </template>
        </div>
        <div class="page-contain">
             <div class="page-limit">
                 <div class="pageWrap">
                    <h2 class="title">法律咨询</h2>
                    <el-form ref="form" :model="form" :rules="rules" label-width="98px">
                        <el-form-item label="咨询详情" prop="content">
                            <el-input v-model="form.content" type="textarea" placeholder="发布您关于律师的专业知识"></el-input>
                        </el-form-item>
                        <el-form-item>
                            <div class="btnGroups">
...
<script>
    import BreadcrumbMult from './../index/BreadcrumbMult'
     import {publishAdvice} from '@/api/api'
    export default {
        data() {
            return {
                form: {
...
.pageWrap .el-form .el-textarea__inner{
    padding: 15px;
    height: 400px;
}
